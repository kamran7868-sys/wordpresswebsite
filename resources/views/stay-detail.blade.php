...
<head>
  ...
  <!-- MAIN BRAND STYLESHEET, EXPLORE PACKAGES & STAY DETAIL STYLESHEETS -->
  <style>
/* ==========================================================================
...
<body>
  ...
  <div class="modal-overlay" id="modalOverlay">
    <div class="modal-card">
      ...
      <p style="font-size: 0.95rem; color: var(--color-slate); line-height: 1.6; margin-bottom: 1.75rem;">
        Your inquiry for Rocky Mountaineer Luxury Express has been received by our Canadian travel specialists.
  ...
  <!-- MAIN INTERACTIVE CONTROLLER (Unified Central Script) -->
  <script>
/**
