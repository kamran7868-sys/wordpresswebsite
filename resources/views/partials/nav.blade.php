...
<style>
  ...
  /* Mobile Devices (< 768px): Hide Top Utility Strip, Keep Drawer Utility & Enhance Logo */
  @media (max-width: 767px) {
    ...
    :root {
      --utility-bar-height: 0px !important;
    }
...
<header class="main-header" id="main-header">
  <div class="container header-inner">
    ...
    <nav class="nav-menu" id="mainNavMenu" aria-label="Primary Navigation">
      ...
      <div class="nav-menu-mobile-action">
        <a href="{{ route('register-dmc') }}" class="btn-primary mobile-menu-btn">Register as a DMC</a>
      </div>

      <!-- MOBILE ONLY: QUICK TRAVEL SERVICES & UTILITY -->
      <div class="nav-menu-mobile-utility">
        <span class="mobile-utility-title">Quick Travel Services</span>
        <div class="mobile-utility-grid">
          <a href="{{ route('home') }}#travel-categories" data-tab="packages-panel" class="mobile-utility-item">
          ...
          <a href="{{ route('home') }}#travel-categories" data-tab="flights-panel" class="mobile-utility-item">
          ...
          <a href="{{ route('home') }}#travel-categories" data-tab="hotels-panel" class="mobile-utility-item">
          ...
          <a href="{{ route('home') }}#travel-categories" data-tab="cruises-panel" class="mobile-utility-item">
        ...
        <div class="mobile-utility-footer">
          <svg viewBox="0 0 24 24"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
          <span>Toronto, ON, Canada &bull; Registered Canadian Tour Operator</span>
        </div>
      </div>
    </nav>
    ...
    <div class="nav-actions">
      <a href="{{ route('register-dmc') }}" class="btn-primary header-nav-action-btn">Register as a DMC</a>
