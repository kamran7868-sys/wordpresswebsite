...
$dmcPageSchema = [
    ...
    '@type' => 'WebPage',
    '@id' => route('register-dmc') . '#webpage',
    'url' => route('register-dmc'),
    'name' => 'Destination Management Company (DMC) Partnership | Premium Global Expeditions',
    'description' => 'Apply to partner as a certified local Destination Management Company (DMC) with Premium Global Expeditions Canadian luxury travel network.',
    'isPartOf' => [
        '@id' => url('/') . '/#website',
    ],
    'mainEntity' => [
        '@type' => 'Service',
        'name' => 'DMC Partnership Program',
        'provider' => [
            '@id' => url('/') . '/#organization',
        ],
        'serviceType' => 'Inbound Tour Operator & Destination Management Partnership',
        'areaServed' => 'Global',
        'description' => 'Selective global partnerships with verified local Destination Management Companies providing premium ground handling, bespoke excursions, and VIP concierge services.',
    ],
];
...
$dmcBreadcrumb = [
    ...
    'itemListElement' => [
        ...
        [
            '@type' => 'ListItem',
            'position' => 2,
            'name' => 'Register as DMC',
            'item' => route('register-dmc'),
        ],
    ],
];
@endphp
<script type="application/ld+json">
{!! json_encode($dmcPageSchema, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) !!}
</script>
<script type="application/ld+json">
{!! json_encode($dmcBreadcrumb, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) !!}
</script>
@endpush
