...
<head>
  ...
  <title>Curated Packages &amp; Travel Services | Premium Global Expeditions Inc.</title>
  <meta name="description"
    content="Explore curated all-inclusive holiday packages, luxury cruises, flight ticketing, and 5-star hotel accommodations with Premium Global Expeditions Inc. (PGE).">
  ...
  <!-- Master Brand Stylesheet & Dedicated Packages Stylesheet -->
  <style>
/* ==========================================================================
...
<body>
  ...
  <section class="top-utility-bar" id="utility-bar">
    <div class="container utility-bar-inner">
      <nav class="utility-links" aria-label="Quick Travel Services">
        <a href="#packages-section" class="utility-link-item">
        ...
        <span class="utility-sep">|</span>
        <a href="#air-ticketing-section" class="utility-link-item">
          <svg viewBox="0 0 24 24">
            <path
        ...
        <span class="utility-sep">|</span>
        <a href="#hotels-section" class="utility-link-item">
          <svg viewBox="0 0 24 24">
            <path
        ...
        <span class="utility-sep">|</span>
        <a href="#cruises-section" class="utility-link-item">
          <svg viewBox="0 0 24 24">
            <path
  ...
  <!-- ==========================================================================
       SECTION 2: MAIN NAVIGATION HEADER (Sticky Nav on Scroll, "Packages" active)
       ========================================================================== -->
  <header class="main-header" id="main-header">
    <div class="container header-inner">
      ...
      <nav class="nav-menu" id="mainNavMenu" aria-label="Primary Navigation">
        ...
        <a href="{{ route('packages') }}" class="nav-link active">Packages</a>
  ...
  <main>
    ...
    <section class="subpage-hero-section" id="packages-hero">
      <img src="https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?q=80&w=1920&auto=format&fit=crop"
        alt="Premium Global Expeditions Packages &amp; Bespoke Journeys" class="subpage-hero-bg"
          ...
          <article class="card-item" data-group="north-america">
            <div class="card-img-wrap">
              <img src="https://images.unsplash.com/photo-1503614472-8c93d56e92ce?q=80&w=800&auto=format&fit=crop"
                alt="Rocky Mountaineer Express Canada" class="card-img" width="800" height="600" loading="lazy">
          ...
          <article class="card-item" data-group="middle-east">
            <div class="card-img-wrap">
              <img src="https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?q=80&w=800&auto=format&fit=crop"
                alt="Wonders of Ancient Egypt Pyramids" class="card-img" width="800" height="600" loading="lazy">
          ...
          <article class="card-item" data-group="southeast-asia">
            <div class="card-img-wrap">
              <img src="https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?q=80&w=800&auto=format&fit=crop"
                alt="Thailand Islands Phuket" class="card-img" width="800" height="600" loading="lazy">
          ...
          <article class="card-item" data-group="south-asia">
            <div class="card-img-wrap">
              <img src="https://images.unsplash.com/photo-1586861635167-e5223aadc9fe?q=80&w=800&auto=format&fit=crop"
                alt="Sri Lanka Heritage Nine Arch" class="card-img" width="800" height="600" loading="lazy">
          ...
          <article class="card-item" data-group="middle-east">
            <div class="card-img-wrap">
              <img src="https://images.unsplash.com/photo-1608848461950-0fe51dfc41cb?q=80&w=800&auto=format&fit=crop"
                alt="Cappadocia Turkey Ballooning" class="card-img" width="800" height="600" loading="lazy">
          ...
          <article class="card-item" data-group="southeast-asia">
            <div class="card-img-wrap">
              <img src="https://images.unsplash.com/photo-1528127269322-539801943592?q=80&w=800&auto=format&fit=crop"
                alt="Ha Long Bay Vietnam Heritage" class="card-img" width="800" height="600" loading="lazy">
          ...
          <article class="card-item" data-group="alaska-singapore">
            <a href="{{ route('voyage-detail') }}" class="card-img-wrap card-img-link" aria-label="View Inside Passage Glacier Voyage">
              <img src="https://images.unsplash.com/photo-1548574505-5e239809ee19?q=80&w=1000&auto=format&fit=crop"
                alt="Alaskan Cruise Liner in Fjord Glaciers" class="card-img" width="1000" height="750" loading="lazy">
          ...
          <article class="card-item" data-group="alaska-singapore">
            <a href="{{ route('voyage-detail') }}" class="card-img-wrap card-img-link" aria-label="View Southeast Asian Spice Route Expedition">
              <img src="https://images.unsplash.com/photo-1518684079-3c830dcef090?q=80&w=1000&auto=format&fit=crop"
                alt="Singaporean Luxury Cruise Ship" class="card-img" width="1000" height="750" loading="lazy">
          ...
          <article class="card-item" data-group="nile-australia">
            <a href="{{ route('voyage-detail') }}" class="card-img-wrap card-img-link" aria-label="View Pharaohs River Expedition on the Nile">
              <img src="https://images.unsplash.com/photo-1539650116574-8efeb43e2750?q=80&w=1000&auto=format&fit=crop"
                alt="Nile River Sunset Cruise" class="card-img" width="1000" height="750" loading="lazy">
          ...
          <article class="card-item" data-group="nile-australia">
            <a href="{{ route('voyage-detail') }}" class="card-img-wrap card-img-link" aria-label="View Great Barrier Reef & Southern Ocean Voyage">
              <img src="https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?q=80&w=1000&auto=format&fit=crop"
                alt="Australian Barrier Reef Cruise" class="card-img" width="1000" height="750" loading="lazy">
      ...
      <div class="container">
        ...
        <div class="cards-grid" id="hotels-grid">
          ...
          <article class="card-item" data-group="hotel-g1">
            <div class="card-img-wrap">
              <img src="https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=800&auto=format&fit=crop"
                alt="Fairmont Banff Springs Hotel Canada" class="card-img" width="800" height="600" loading="lazy">
              <span class="card-tag">Canada</span>
            </div>
            <div class="card-body">
          ...
          <article class="card-item" data-group="hotel-g1">
            <div class="card-img-wrap">
              <img src="https://images.unsplash.com/photo-1582719508461-905c673771fd?q=80&w=800&auto=format&fit=crop"
                alt="Amangalla Resort Sri Lanka" class="card-img" width="800" height="600" loading="lazy">
              <span class="card-tag">Sri Lanka</span>
            </div>
            <div class="card-body">
          ...
          <article class="card-item" data-group="hotel-g1">
            <div class="card-img-wrap">
              <img src="https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?q=80&w=800&auto=format&fit=crop"
                alt="Four Seasons Cairo Egypt" class="card-img" width="800" height="600" loading="lazy">
              <span class="card-tag">Egypt</span>
            </div>
            <div class="card-body">
          ...
          <article class="card-item" data-group="hotel-g1">
            <div class="card-img-wrap">
              <img src="https://images.unsplash.com/photo-1571896349842-33c89424de2d?q=80&w=800&auto=format&fit=crop"
                alt="Anantara Chiang Mai Thailand" class="card-img" width="800" height="600" loading="lazy">
              <span class="card-tag">Thailand</span>
            </div>
            <div class="card-body">
          ...
          <article class="card-item" data-group="hotel-g2">
            <div class="card-img-wrap">
              <img src="https://images.unsplash.com/photo-1540555700478-4be289fbecef?q=80&w=800&auto=format&fit=crop"
                alt="Six Senses Con Dao Resort Vietnam" class="card-img" width="800" height="600" loading="lazy">
              <span class="card-tag">Vietnam</span>
            </div>
            <div class="card-body">
          ...
          <article class="card-item" data-group="hotel-g2">
            <div class="card-img-wrap">
              <img src="https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=800&auto=format&fit=crop"
                alt="Dwarikas Hotel Kathmandu Nepal" class="card-img" width="800" height="600" loading="lazy">
          ...
          <article class="card-item" data-group="hotel-g2">
            <div class="card-img-wrap">
              <img src="https://images.unsplash.com/photo-1641128324972-af3212f0f6bd?q=80&w=800&auto=format&fit=crop"
                alt="Museum Hotel Cappadocia Turkey" class="card-img" width="800" height="600" loading="lazy">
              <span class="card-tag">Turkey</span>
            </div>
            <div class="card-body">
  ...
  <!-- ==========================================================================
       SECTION 10: FOOTER SECTION (Identical to Home Page)
       ========================================================================== -->
    ...
    <div class="container">
      ...
      <div class="footer-grid">
        ...
        <div class="footer-links-col">
          ...
          <ul class="footer-links-list">
            <li><a href="#packages-section" class="footer-dest-link"><span class="footer-link-pin">&#9679;</span> Canadian Rockies &amp; Banff</a></li>
            <li><a href="#packages-section" class="footer-dest-link"><span class="footer-link-pin">&#9679;</span> Ancient Egypt &amp; Nile Expedition</a></li>
            <li><a href="#packages-section" class="footer-dest-link"><span class="footer-link-pin">&#9679;</span> Sri Lanka &amp; Indian Ocean</a></li>
            <li><a href="#packages-section" class="footer-dest-link"><span class="footer-link-pin">&#9679;</span> Thailand Beach &amp; Culture</a></li>
            <li><a href="#packages-section" class="footer-dest-link"><span class="footer-link-pin">&#9679;</span> Cappadocia &amp; Turkey</a></li>
            <li><a href="#cruises-section" class="footer-dest-link"><span class="footer-link-pin">&#9679;</span> Alaskan Glacier Cruise</a></li>
          </ul>
        </div>
...
<span>Toronto, ON, Canada</span>
  ...
  <div class="modal-overlay" id="modalOverlay">
    <div class="modal-card">
      <span class="section-tagline" style="color: var(--color-gold); font-size: 1.2rem;">Inquiry Received</span>
      <h3 style="font-family: var(--font-display); font-size: 2rem; color: var(--color-navy); margin-top: 0.5rem; margin-bottom: 0.75rem;">
        Thank You for Choosing PGE!</h3>
      <p style="font-family: var(--font-body); font-size: 0.95rem; color: var(--color-slate); line-height: 1.65; margin-bottom: 1.75rem;">
        Your airline ticketing inquiry has been sent to our Canadian travel specialists. We will review your travel preferences and return with suitable flight options within 24 hours.
      </p>
      <button class="btn-primary" id="modalCloseBtn">Return to Site</button>
    </div>
  </div>

  <!-- JAVASCRIPT CONTROLLER (Shared across site) -->
  <script>
/**
